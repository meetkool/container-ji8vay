...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ji8vay.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ji8vay.containers.anotherwebservice.com/
...
```
git clone git@github.com:meetkool/container-ji8vay.git
cd container-ji8vay
```
...
```
docker attach container-ji8vay
```
